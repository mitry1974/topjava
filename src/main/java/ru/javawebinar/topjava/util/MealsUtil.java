...
public class MealsUtil {
    ...
    public static final List<Meal> MEALS2 = Arrays.asList(
            ...
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 10, 0), "Завтрак2", 1000),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 13, 0), "Обед2", 500),
            new Meal(LocalDateTime.of(2015, Month.MAY, 31, 20, 0), "Ужин2", 510)
    );
